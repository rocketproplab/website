...
<?php if ($showServices == 1) : ?>
	<?php
		...
		$singleServiceBox1 = freddo_options('_onepage_choosepage_1_services');
		$singleServiceBox2 = freddo_options('_onepage_choosepage_2_services');
		$singleServiceBox3 = freddo_options('_onepage_choosepage_3_services');
		$singleServiceBox4 = freddo_options('_onepage_choosepage_4_services');
		$singleServiceBox5 = freddo_options('_onepage_choosepage_5_services');
		$singleServiceBox6 = freddo_options('_onepage_choosepage_6_services');
		...
		<div class="services_columns">
			<div class="one services_columns_single">
				...
				<?php if ($singleServiceBox1): ?>
					<?php
						$singleServiceFont1 = freddo_options('_onepage_fontawesome_1_services', 'fa fa-bell');
					?>
				...
				<?php if ($singleServiceBox2): ?>
					<?php
						$singleServiceFont2 = freddo_options('_onepage_fontawesome_2_services', 'fa fa-bell');
					?>
					<div class="singleService">
				...
				<?php if ($singleServiceBox3): ?>
					<?php
						$singleServiceFont3 = freddo_options('_onepage_fontawesome_3_services', 'fa fa-bell');
					?>
					<div class="singleService">
				...
				<?php if ($singleServiceBox4): ?>
					<?php
						$singleServiceFont4 = freddo_options('_onepage_fontawesome_4_services', 'fa fa-bell');
					?>
					<div class="singleService">
				...
				<?php if ($singleServiceBox5): ?>
					<?php
						$singleServiceFont5 = freddo_options('_onepage_fontawesome_5_services', 'fa fa-bell');
					?>
					<div class="singleService">
				...
				<?php if ($singleServiceBox6): ?>
					<?php
						$singleServiceFont6 = freddo_options('_onepage_fontawesome_6_services', 'fa fa-bell');
					?>
					<div class="singleService">
